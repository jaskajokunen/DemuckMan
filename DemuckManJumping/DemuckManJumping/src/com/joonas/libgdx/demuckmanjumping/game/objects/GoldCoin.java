...
public class GoldCoin extends AbstractGameObject {
	...
	//Sis‰lt‰‰ tekstuuri atlaksen alikuvan, jossa kolikko
	...
	public void render(SpriteBatch batch) {
		...
		//Jos kolikko on ker‰tty, eli se ei ole n‰kyviss‰,
		...
		//Asetetaan alikuvaksi kolikon kuva
		reg = regGoldCoin;
	...
	//Metodi palauttaa pistem‰‰r‰n, jonka pelaaja saa, kun h‰n ker‰‰ kolikon
	public int getScore() {
		return 100;
	}
